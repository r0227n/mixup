...
@Riverpod(keepAlive: true)
PracticeTimelineRepository practiceTimelineRepository(Ref ref) =>
    JsonPracticeTimelineRepository(
      ref
          .watch(contentSettingsProvider.future)
          .then((value) => value.songsPath),
    );
